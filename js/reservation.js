...
const addEvents = () => {
    ...
    reservation_btn.addEventListener('click', function () {
        ...
        let depart_code = document.querySelector('div.reservation_wrap input[name="depart_code"]').value;
        let depart_date = document.querySelector('div.reservation_wrap input[name="depart_date"]').value;
        let arrive_code = document.querySelector('div.reservation_wrap input[name="arrive_code"]').value;
        let arrive_date = document.querySelector('div.reservation_wrap input[name="arrive_date"]').value;
        let adult = document.querySelector('div.reservation_wrap input[name="adult"]').value;
        let infant = document.querySelector('div.reservation_wrap input[name="infant"]').value;
        let child = document.querySelector('div.reservation_wrap input[name="child"]').value;
        addAirplane(u_id, depart_code,depart_date,arrive_code,arrive_date,adult,infant,child);
