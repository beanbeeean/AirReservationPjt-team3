const addEventsProfile = () => {
  ...
  let editProfileMenuBtn = document.querySelector(
    "div.menu_wrap > a.sign_modify"
  );
  editProfileMenuBtn.addEventListener("click", function () {
    console.log("editProfileBtn CLICKED!!!!");

    let current_id = document.querySelector(
      "div.sign_modify_wrap div.current_id"
    );
  ...
  signUpBtn.addEventListener("click", function () {
    ...
    let u_gender = document.querySelector(
      'div.sign_up_wrap select[name="u_gender"]'
    ).value;
    let u_mail = document.querySelector(
      'div.sign_up_wrap input[name="u_mail"]'
    ).value;
    let u_phone = document.querySelector(
      'div.sign_up_wrap input[name="u_phone"]'
    ).value;
  ...
  signInBtn.addEventListener("click", function () {
    ...
    setMenuStatus(SIGN_IN_STATUS);
    // showSelectedView("예약페이지")
  });

  let editProfileBtn = document.querySelector(
    "div.sign_modify_wrap button.sign_modify_btn"
  );
  editProfileBtn.addEventListener("click", function () {
    ...
    let u_pw = document.querySelector(
      'div.sign_modify_wrap input[name="u_pw"]'
    ).value;
    let u_gender = document.querySelector(
      'div.sign_modify_wrap select[name="u_gender"]'
    ).value;
    let u_mail = document.querySelector(
      'div.sign_modify_wrap input[name="u_mail"]'
    ).value;
    let u_phone = document.querySelector(
      'div.sign_modify_wrap input[name="u_phone"]'
    ).value;
  ...
  let deleteProfileBtn = document.querySelector(
    "div.sign_modify_wrap > button.delete_user_btn"
  );
